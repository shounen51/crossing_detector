...
class crossing_detector():
    ...
    def get_area_list(self):
        return list(self.areaDict.keys())
...
def is_point_in_here(temp, aindex, area, bboxes, td=1):
...
if __name__ == "__main__":
    ...
    areaSetDict["areaName"] = "BBB"
    detector.add_area_dict(areaSetDict)
    areaSetDict["areaName"] = "CCC"
    detector.add_area_dict(areaSetDict)
    _ad = detector.get_area_list()
    size = (1080,810)
    bbox_xyxy_list = np.array([[760.0,234.0,867.0,454.0],[760.0,234.0,867.0,454.0]])
    # while 1:
    #     returnList = detector.detector(bbox_xyxy_list, size)
    #     print(returnList)
    #     print('--------------------')
    #     time.sleep(0.5)
    ...
    while 1:
        returnList = detector.detector(bbox_xyxy_list)
        print(returnList)
        print('--------------------')
        time.sleep(0.5)
